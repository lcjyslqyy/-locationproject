...
using Base_Helper.PetaPoco.DatabaseTypes;
using Base_Helper.PetaPoco.Internal;
using System;
...
namespace Base_Helper.PetaPoco
{
    /// <summary>
    ...
    public class Database : IDisposable
    {
        ...
        public Database(IDbConnection connection)
        {
            ...
            _helperconnectionString = connection.ConnectionString;
        ...
        public Database(string connectionString, string providerName)
        {
            ...
            _helperconnectionString = connectionString;
        ...
        public Database(string connectionStringName)
        {
            ...
            _helperconnectionString = _connectionString;
            _providerName = providerName;
            CommonConstruct();
        }
        ...
        public PageGrid PageGrid(long page, long itemsPerPage, string sqlCount, object[] countArgs, string sqlPage, object[] pageArgs)
        {
            var saveTimeout = OneTimeCommandTimeout;

            // Setup the paged result
            var result = new PageGrid
            {
                //CurrentPage = page,
                //ItemsPerPage = itemsPerPage,
                //TotalItems = ExecuteScalar<long>(sqlCount, countArgs)
                ...
                total = ExecuteScalar<long>(sqlCount, countArgs)
            };

            OneTimeCommandTimeout = saveTimeout;

            // Get the records
            result.rows = Fill(sqlPage, pageArgs);
        ...
        /// <returns></returns>
        public PageGrid PageGrid(long page, long itemsPerPage, string sql, params object[] args)
        {
            string sqlCount, sqlPage;
            BuildPageQueries((page - 1) * itemsPerPage, itemsPerPage, sql, ref args, out sqlCount, out sqlPage);
            return PageGrid(page, itemsPerPage, sqlCount, args, sqlPage, args);
        }
        ...
        public PageGrid PageGrid(long page, long itemsPerPage, Sql sql)
        {
            return PageGrid(page, itemsPerPage, sql.SQL, sql.Arguments);
        }
        ...
        /// <param name="sql">Sql语句</param>
        /// <param name="args">参数</param>
        public DataTable Fill<T>(string sql, params object[] args)
        {
            if (EnableAutoSelect)
                sql = AutoSelectHelper.AddSelectClause<T>(_dbType, sql);
        ...
        public string _helperconnectionString;
